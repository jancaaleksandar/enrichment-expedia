...
class LeadHotelMappingData(Base):
    ...
    lead_hotel_mapping_data_lead_id = Column(
        Integer, ForeignKey("public.leads.lead_id"), primary_key=True
    )
...
class LeadHotelCompetitorData(Base):
    ...
    __table_args__ = {"schema": "public"}
    lead_hotel_competitor_data_id = Column(
        Integer, primary_key=True, autoincrement=True
    )
    # NOTE: Actual DB column is named without the "_data" segment per migration/new.sql
    lead_hotel_competitor_lead_id = Column(
        Integer, ForeignKey("public.leads.lead_id"), nullable=False
    )
    ...
    lead_hotel_competitor_data_hotel_review_score = Column(
...
class RawHotelData(Base):
    ...
    raw_hotel_data_price_provider_url = Column(
    ...
    raw_hotel_data_competitor_data_id = Column(
        Integer,
        ForeignKey("public.lead_hotel_competitor_data.lead_hotel_competitor_data_id"),
        nullable=True,
    )
