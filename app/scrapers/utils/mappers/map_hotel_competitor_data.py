...
def map_hotel_competitor_data(
    ...
    for competitor in competitor_data:
        lead_hotel_competitor_data = LeadHotelCompetitorData(
            ...
            lead_hotel_competitor_data_request_provider_id=competitor.competitor_parsed_data_hotel_id,
            lead_hotel_competitor_data_request_provider_url=competitor.competitor_parsed_data_hotel_url,
            lead_hotel_competitor_data_hotel_name=competitor.competitor_parsed_data_hotel_name,
